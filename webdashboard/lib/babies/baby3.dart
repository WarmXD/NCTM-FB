...
class BabyThree extends StatefulWidget {
  const BabyThree({super.key});

  @override
  State<BabyThree> createState() => _BabyThreeState();
}

class _BabyThreeState extends State<BabyThree> {
  @override
  ...
  Future<String> getName() async {
    ...
    return names.length > 2 ? names[2] : 'No Baby';
  }
}
