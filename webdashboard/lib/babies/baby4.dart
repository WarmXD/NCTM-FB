...
class BabyFour extends StatefulWidget {
  const BabyFour({super.key});

  @override
  State<BabyFour> createState() => _BabyFourState();
}

class _BabyFourState extends State<BabyFour> {
  @override
  ...
  Future<String> getName() async {
    ...
    return names.length > 3 ? names[3] : 'No Baby';
  }
}
